...
from tagging_text import bioTag, bioTag_ml, bioTag_dic
        ...
        with open(outfile,'w', encoding='utf8') as fout:
            ...
            for document in collection.documents:
                ...
                for passage in document.passages:
                    ...
                    # tag_result=bioTag_ml(passage.text,nn_model,onlyLongest=para_set['onlyLongest'], abbrRecog=para_set['abbrRecog'],Threshold=para_set['ML_Threshold']) 
                    tag_result=bioTag_dic(passage.text,biotag_dic,onlyLongest=para_set['onlyLongest'], abbrRecog=para_set['abbrRecog']) 
                    for ele in tag_result:
...
def phenotagger_tag(infolder,para_set,outfolder):
    ...
    if para_set['model_type']=='pubmedbert':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    ...
                    'lowercase':True}
        modelfile='../models/pubmedbert' + dev_name + is_sy + method + '.h5'
        
    elif para_set['model_type']=='sapbert':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    'checkpoint_path':'/root/autodl-tmp/Models/SapBERT-from-PubMedBERT-fulltext/',
                    'lowercase':True}
        modelfile='../models/sapbert' + dev_name + is_sy + method + '.h5'

    elif para_set['model_type']=='hposy1':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    'checkpoint_path':'/root/autodl-tmp/Models/pubmedberthposy_epoch_1/',
                    'lowercase':True}
        modelfile='../models/hposy1' + dev_name + is_sy + method + '.h5'
        
    elif para_set['model_type']=='UMLShposy1':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    'checkpoint_path':'/root/autodl-tmp/Models/pubmedberthpoumlssy_epoch_1/',
                    'lowercase':True}
        modelfile='../models/UMLShposy1' + dev_name + is_sy + method + '.h5'
        
    elif para_set['model_type']=='UMLShposy10':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    'checkpoint_path':'/root/autodl-tmp/Models/pubmedberthpoumlssy_epoch_10/',
                    'lowercase':True}
        modelfile='../models/UMLShposy10' + dev_name + is_sy + method + '.h5'

    elif para_set['model_type']=='hposy5':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    'checkpoint_path':'/root/autodl-tmp/Models/pubmedberthposy_epoch_5/',
                    'lowercase':True}
        modelfile='../models/hposy5' + dev_name + is_sy + method + '.h5'

    elif para_set['model_type']=='hposy10':
        vocabfiles={'labelfile':'../dict/lable.vocab',
                    'checkpoint_path':'/root/autodl-tmp/Models/pubmedberthposy_epoch_10/',
                    'lowercase':True}
        modelfile='../models/hposy10' + dev_name + is_sy + method + '.h5'
...
if __name__=="__main__":
    ...
    parser.add_argument('--modeltype', '-m', help="the model type",default='pubmedbert')
    ...
    para_set={
              'model_type':args.modeltype, # cnn, bioformer, pubmedbert or biobert
