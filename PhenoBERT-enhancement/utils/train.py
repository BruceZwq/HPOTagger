...
train_file_path="../models/final_train.txt"
val_file_path="../models/val_copd.txt"
test_file_path="../models/test_copd.txt"
model_save_path="../models/HPOModel_H/model_layer1_copd.pkl"
